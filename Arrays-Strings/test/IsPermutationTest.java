...
public class IsPermutationTest {
    ...
    public void testPermutation() {
        ...
        assertTrue(IsPermutation.isPermutation3("abc", "bca"), "The strings 'abc' and 'bca' should be permutations of each other.");
    }
    ...
    public void testNotPermutation() {
        ...
        assertFalse(IsPermutation.isPermutation3("abc", "def"), "The strings 'abc' and 'def' should not be permutations of each other.");
    }
    ...
    public void testDifferentLengths() {
        ...
        assertFalse(IsPermutation.isPermutation3("abcd", "abc"), "Strings of different lengths cannot be permutations of each other.");
    }
    ...
    public void testEmptyStrings() {
        ...
        assertTrue(IsPermutation.isPermutation3("", ""), "Two empty strings should be permutations of each other.");
    }
    ...
    public void testOneEmptyString() {
        ...
        assertFalse(IsPermutation.isPermutation3("abc", ""), "A non-empty string and an empty string cannot be permutations of each other.");
    }
    ...
    public void testNullStrings() {
        ...
        assertFalse(IsPermutation.isPermutation3(null, "abc"), "A null string and a non-null string cannot be permutations of each other.");
        assertFalse(IsPermutation.isPermutation3("abc", null), "A null string and a non-null string cannot be permutations of each other.");
        assertFalse(IsPermutation.isPermutation3(null, null), "Two null strings should not be considered permutations of each other.");
    }
    ...
    public void testSpecialCharacters() {
        ...
        assertTrue(IsPermutation.isPermutation3("a!b@c", "c@b!a"), "The strings 'a!b@c' and 'c@b!a' should be permutations of each other.");
    }
    ...
    public void testIdenticalStrings() {
        ...
        assertTrue(IsPermutation.isPermutation3("abcd", "abcd"), "Identical strings should be permutations of each other.");
    }
    ...
    public void testCaseSensitivity() {
        ...
        assertFalse(IsPermutation.isPermutation3("abc", "ABC"), "The strings 'abc' and 'ABC' should not be permutations of each other (case-sensitive).");
    }
